...
public class TetrisUnitTest {
	private static final int PIECE_COUNT = 0;
	...
	@Test
	//add in HW2
	public void testRotateBarShape() {
		Grid g = new Grid();
		
		Piece shape = new LShape(3,0,g);
		assertFalse(shape.canRotate());
		
		Piece shape2 = new JShape(10,Grid.WIDTH-1,g);
		assertFalse(shape2.canRotate());
	
		Piece shape3 = new LShape(3,Grid.WIDTH/2-1,g);
	    assertTrue(shape3.canRotate());
